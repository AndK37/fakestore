<template>
    <div class="header">
        <span @click="this.$router.push('/')" class="title">FakeStore</span>
        <svg @click="this.$router.push('/cart')" xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="white">
            <path
